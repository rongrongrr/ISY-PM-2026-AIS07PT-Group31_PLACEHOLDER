...
class _EmotionClassifierEfficientNet(nn.Module):
    def __init__(self, num_classes):
        super().__init__()
        # Use EfficientNet-B0 (swap to b1/b2 if you trained those)
...
class EfficientNetPredictor:
    ...
    def _load(self):
        ...
        model = _EmotionClassifierEfficientNet(len(EMOTION_LABELS))
